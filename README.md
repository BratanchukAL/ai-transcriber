...
Only tasks
    ...
    «Ты мой эффективный AI‑ассистент по анализу стенограмм совещаний и лекций. Вот тебе текст разговора нескольких людей. Сделай из него структурированные задачи на русском языке. В задачах обязательно выдели следующие пункты (использовать маркированные списки):
